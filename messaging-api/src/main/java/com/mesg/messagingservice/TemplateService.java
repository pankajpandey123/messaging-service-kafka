...
public class TemplateService {
	...
	public EmailContentDto generateProjectStatusChangeMail(ProjectStatusDto projectStatusDto) {
		...
		return EmailContentDto.builder().text(templateEngine.process("project-status-change.txt", context))
				.html(templateEngine.process("project-status-change.html", context)).build();
